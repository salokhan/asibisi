...
import { QuestionCreateBodyDTO, QuestionResponseObjectDTO, questionTypeEnum } from '../DTOs/question.dto';
...
export class QuestionPaperService {
  ...
  public async createQuestion(Question: QuestionCreateBodyDTO): Promise<QuestionResponseObjectDTO> {
